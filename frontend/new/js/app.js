(function(){
  ...
  var app = angular.module('app', ['ui.grid','ui.grid.edit', 'ui.grid.selection', 'xeditable', 'ui.router',  'ngAnimate',
    'ngCookies',
    'ngResource',
    'ngSanitize',
    'ngTouch',
  ...
  app.controller('BDDFrameworkController', function($scope, $http, $timeout, $filter) {
